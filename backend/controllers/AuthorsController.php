...
class AuthorsController extends Controller
{
            ...
            if ($this->request->isPost) {
                if ($model->load($this->request->post())) {
                    ...
                    if($image) {
                        ...
                        $image->saveAs('@frontend/images/authors/' . $imageName);
                        $model->img = $imageName;
                    }
                    else{
    ...
    {
        if(Yii::$app->user->identity != NULL) {
            $data = Authors::findOne($id);
            if($data->img != "default.png")
                unlink(\Yii::getAlias('@frontend').'/images/authors/' . $data->img);
    ...
    public function actionOdstranitfoto($id)
    {
        if(Yii::$app->user->identity != NULL) {
            ...
            if($model->img != "default.png")
                unlink(\Yii::getAlias('@frontend').'/images/authors/' . $model->img);
